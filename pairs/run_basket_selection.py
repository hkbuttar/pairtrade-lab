"""CLI entry point: run Johansen basket selection across the full universe.

Usage:
    python -m pairs.run_basket_selection --start 2018-01-01 --end 2025-01-01

Defaults to 3- and 4-leg baskets only; 5-leg baskets multiply the search
